      ...
      <div className="container flex flex-col mx-auto bg-white">
        ...
        >
          <div className="flex shrink-0 px-8 items-center justify-between h-[96px]">
            <a className="transition-colors w-20  m-auto duration-200 ease-in-out">
              <img
                alt="Logo"
                src="https://assets.stickpng.com/images/62b30f8cb223544c209f5e56.png"
                className="inline"
              />{" "}
            </a>
          </div>
            ...
            <div className="flex flex-col w-full font-medium">
              <div>
                <span className="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem]">
                  <a className="flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 text-stone-500 hover:text-dark">
                    Sales
                  </a>
                </span>
              </div>
